 ...
 * @author MSI-NB
 */
public class UpdateReserveFrame extends JInternalFrame {
    ...
    public UpdateReserveFrame() {
        setIconifiable(true);
        setClosable(true);
        setTitle("update reserve information");
        setSize(800, 600);
        setLayout(null);
        init();
        addListener();
    ...
    private void addListener() {
        ...
        jButton.addActionListener(e -> {
            ...
            if (service.update(reserve)) {
                JOptionPane.showMessageDialog(null,
                        "reserve info update success");
            } else {
                JOptionPane.showMessageDialog(null,
                        "reserve info update fail");
            }
        });
    }
}
