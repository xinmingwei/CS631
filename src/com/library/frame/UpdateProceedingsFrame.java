 ...
 * @author MSI-NB
 */
public class UpdateProceedingsFrame extends JInternalFrame {
    ...
    public UpdateProceedingsFrame() {
        setIconifiable(true);
        setClosable(true);
        setTitle("update proceeding information");
        setSize(800, 670);
        setLayout(null);
        init();
        addListener();
    ...
    private void addListener() {
        ...
        jButton.addActionListener(e -> {
            ...
            if (service.update(proceeding)) {
                JOptionPane.showMessageDialog(null,
                        "update proceeding success");
            } else {
                JOptionPane.showMessageDialog(null,
                        "update proceeding fail");
            }
        });
    }
}
